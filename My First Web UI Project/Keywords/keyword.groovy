...
class keyword {
	...
	@Keyword //chuyển tiền về dạng số
	def String ChuyenTienVeDangSo(String tien) {
		String Gia = tien.replaceAll(",", "").replaceAll("đ", "")//cắt dấu , và 'đ'
		return Gia
	}
	...
	def String TinhGiaTien(String sl, String GiaGoc) {
		...
		int Gia = ChuyenTienVeDangSo(GiaGoc).toInteger()//xử lý giá ban đầu chứa , 'đ'
